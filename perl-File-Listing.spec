%{?scl:%scl_package perl-File-Listing}

Name:           %{?scl_prefix}perl-File-Listing
Version:        6.04
Release:        24%{?dist}
...
%global __requires_exclude %{?__requires_exclude:__requires_exclude|}^%{?scl_prefix}perl\\(HTTP::Date\\)\s*$
# Do not provide private modules
%global __provides_exclude %{?__provides_exclude:__provides_exclude|}^%{?scl_prefix}perl\\(File::Listing::
...
%changelog
* Fri Feb 14 2020 Petr Pisar <ppisar@redhat.com> - 6.04-24
- Import to SCL
